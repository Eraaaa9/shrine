...
export const TUNED_VARIABLE: BotWeights = {
  cardValue: 2.2459,
  costEfficiency: 1.1719,
  buyThreshold: 0.3807,
  duplicatePenalty: 0.2828,
  scarcityBonus: 0.6372,
  denialWeight: -0.129,
  futureDice: 0.2992,
  tableDice: 0.6117,
  blueWeight: 2.2761,
  ...
  redWeight: 0.6002,
  purpleWeight: 2.9798,
  purpleRealism: 0.7518,
  purpleHorizon: 0.9171,
  purpleVolatile: 0.409,
  landmarkValue: 1.0583,
  landmarkUnlock: 0.2223,
  landmarkProgress: 0.1675,
  landmarkRush: 2.4557,
  landmarkOrder: 0.5895,
  saveMargin: 1.6897,
  saveScore: 0.4267,
  twoDiceBias: 0.8424,
  rerollMargin: 0.7164,
  harborMargin: 1.8052,
  spacePortMargin: -0.0588,
  threatWeight: 0.4448,
  exhibitThreshold: 2.4749,
  investFloor: 2.7798,
  investCap: 8.6345,
  renovationSelfHarm: 0.6854,
  eventTrust: 0.0661,
  bankerHold: 0.0831,
  mayorRerollMargin: 0.6685,
  jitter: 0.0162,
};
