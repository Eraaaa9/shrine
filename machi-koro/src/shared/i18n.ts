...
const EN: Record<string, string> = {
  ...
  'ui.income': 'Income',
  'ui.builtStatus': 'built',
  'ui.chainLabel': 'This turn, step by step',
  'ui.chainDoubles': '✨ doubles (+turn)',
  'ui.chainTakes': 'takes',
  'ui.chainPays': 'pays',
  'ui.chainDemolished': 'demolished',
  'ui.marketControls': 'Market view, filter and sorting',
  'ui.shieldTag': '☕ keeps {n} ¤ back',
  'ui.victoryYours': '— a win to remember!',
  'ui.victoryTheirs': 'wins this game!',
  'ui.victoryLandmarks': 'Landmarks',
  'ui.victoryTreasury': "Winner's treasury",
  'ui.victoryLength': 'Length',
  'ui.victoryTurns': '{n} turns',
  'ui.victoryRolls': 'Dice rolls',
  'ui.victoryNextPick': '🎭 Your pick for the next game:',
  'ui.victoryChangeMayor': 'Change mayor',
  'ui.cardsLeft': '{n} left',
  'ui.soldOut': 'sold out',
  'ui.newStack': 'new',
  'ui.youOwn': 'you: {n}',
...
const RU: Record<string, string> = {
  ...
  'ui.income': 'Доход',
  'ui.builtStatus': 'построено',
  'ui.chainLabel': 'Ход по шагам',
  'ui.chainDoubles': '✨ дубль (+ход)',
  'ui.chainTakes': 'забирает',
  'ui.chainPays': 'платит',
  'ui.chainDemolished': 'снесено',
  'ui.marketControls': 'Вид, фильтр и сортировка рынка',
  'ui.shieldTag': '☕ оставляет {n} ¤',
  'ui.victoryYours': '— вы одержали блестящую победу!',
  'ui.victoryTheirs': 'побеждает в этой партии!',
  'ui.victoryLandmarks': 'Достопримечательности',
  'ui.victoryTreasury': 'Казна победителя',
  'ui.victoryLength': 'Длительность',
  'ui.victoryTurns': '{n} ходов',
  'ui.victoryRolls': 'Бросков кубиков',
  'ui.victoryNextPick': '🎭 Ваш выбор на следующую партию:',
  'ui.victoryChangeMayor': 'Сменить Мэра',
...
const KK: Record<string, string> = {
  ...
  'ui.income': 'Кіріс',
  'ui.builtStatus': 'салынды',
  'ui.chainLabel': 'Жүріс қадам-қадам',
  'ui.chainDoubles': '✨ дубль (+жүріс)',
  'ui.chainTakes': 'алады',
  'ui.chainPays': 'төлейді',
  'ui.chainDemolished': 'бұзылды',
  'ui.marketControls': 'Базардың көрінісі, сүзгісі және сұрыптауы',
  'ui.shieldTag': '☕ {n} ¤ қалдырады',
  'ui.victoryYours': '— тамаша жеңіске жеттіңіз!',
  'ui.victoryTheirs': 'осы партияда жеңді!',
  'ui.victoryLandmarks': 'Көрнекті нысандар',
  'ui.victoryTreasury': 'Жеңімпаздың қазынасы',
  'ui.victoryLength': 'Ұзақтығы',
  'ui.victoryTurns': '{n} жүріс',
  'ui.victoryRolls': 'Сүйек тастау',
  'ui.victoryNextPick': '🎭 Келесі партияға таңдауыңыз:',
  'ui.victoryChangeMayor': 'Әкімді ауыстыру',
