...
public class FormInteractions {
    ...
    public FormInteractions(StandardEditor standardEditor) {
        this.editor = standardEditor;
    }
    ...
    @Nullable TextField<String> textField(String componentId) {
        return (TextField<String>) editor.getWindow().getComponent(componentId);
    }

    @Nullable Button button(String buttonId) {
